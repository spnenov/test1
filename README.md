...
The follwoing three libraries are added to the Dockerfile as they are relate to having JSON logging instead of textual ones, which 
allows DataDog to group the logs in a more normal way.
